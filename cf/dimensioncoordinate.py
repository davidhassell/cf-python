...
class DimensionCoordinate(
    ...
    **NetCDF interface**
    ...
    def increasing(self):
        ...
        A dimension coordinate is increasing if its coordinate values
    ...
    def roll(self, axis, shift, inplace=False, i=False):
        ...
        centre = ((self.data[i] // period) * period).squeeze()
        ...
        c._custom["direction"] = direction  # TODODASK - is this necessary?
